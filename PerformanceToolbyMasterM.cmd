...
echo.                                Warning
echo.
echo. Iam are not responsible for any problems/Damages with your PC this may cause
echo.
echo.
echo.
echo.
...
echo.
echo. 
echo. Allows you to revert your PC to the same settings as it was when making the restore point         
echo. You can use a restore point later on in the utility, if you wish to do so                
echo. 
...
echo.
echo.
echo. %w% Downloading Resources Used by the tool... %b%                                                       
echo.
chcp 437 >nul 2>&1
...
echo.                                          
echo.                                                                                                                                                                                           
echo. %p%[%w%1%p%]%w% General Optimizations         %p%[%w%2%p%]%w% Mouse and Keyboard Optimization    %p%[%w%3%p%]%w% Windows Tweaks                                           
echo.                                                                                                                                                                         
echo. %p%[%w%4%p%]%w% PC clean                      %p%[%w%5%p%]%w% Memory/RAM Optimization            %p%[%w%6%p%]%w% Disable Startup Services           
echo.                                                                                                                                                                             
echo. %p%[%w%7%p%]%w% GPU Tweaks                    %p%[%w%8%p%]%w% CPU Tweaks                         %p%[%w%9%p%]%w% USB Tweaks                          
echo.                                                                                                                                                                               
echo. %p%[%w%10%p%]%w% Power Tweaks                 %p%[%w%11%p%]%w% System Debloat                    %p%[%w%12%p%]%w% Storage Tweaks                     
echo.                                                                                                                                                                              
echo. %p%[%w%13%p%]%w% Fix Corrupted Files          %p%[%w%14%p%]%w% Set Full Screen Optimization      %p%[%w%15%p%]%w% Uninstall Useless Apps              
echo.                                                                                                                                                                               
echo. %p%%w%%p%%w%                                  %p%[%w%16%p%]%w% EXM Network Tweaking Utility      %p%%w%%p%%w%                                         
echo.                                                                                                                                                                             
echo.                                            
echo.                                                                                                                                                                            
echo. %p%[%w%R%p%]%w% Reverts / Fixes               %p%[%w%W%p%]%w% Completely Optimize Your PC        %p%[%w%P%p%]%w% Use Restore Point                   
echo.                                                                                                                                                                           
echo. %p%[%w%F%p%]%w% Refresh Resources             %p%[%w%X%p%]%w% Exit The Utility                                  
echo.                                                                                                                                                                         
...
echo.      
echo. %p%[%w%1%p%]%w% Uninstall Useless Apps    
echo.  
echo. %p%[%w%2%p%]%w% Uninstall Windows Preinstalled Apps     
echo.                                                                                           
echo.                                                                                           
...
echo.                                                                                                                                                                        
echo. %p%%w%%p%%w%                                  %p%[%w%A%p%]%w% APPLY ALL (1-7)                                                       
echo.                                                                                                                                                                        
...
echo.                                                                                                                                                                             
echo. %p%[%w%7%p%]%w% Disable Teredo Tunneling                    %p%[%w%8%p%]%w% Optimize NIC Adapter Settings                             
echo.                                                                                                                                                                               
echo. %p%[%w%9%p%]%w% Set a QOS Policy                            %p%[%w%10%p%]%w% Open NIC Settings                                        
echo.                                                                                                                                                                            
echo.                                         
echo.                                                                                                                                                                         
...
powercfg -import "C:\exm\Exm Free Power Plan V5.pow"
powercfg.cpl
timeout /t 1 /nobreak > NUL
echo.
echo.
